...
<!---------------------------------------------  예약고객 개인 정보-------------------------------------->
<form class="jotform-form" id="resvUp" action="resvUp" method="post">
    ...
    <ul class="form-section page-section">
      <li id="cid_3" class="form-input-wide" data-type="control_head">
        <div class="form-header-group  header-large">
          <div class="header-text httal htvam">
            <h1 id="header_3" class="form-header" data-component="header">예약 수정</h1>
          </div>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_fullname" id="id_5"><label class="form-label form-label-top form-label-auto" id="label_5" for="first_5" aria-hidden="false"> 전체 이름 </label>
        <div id="cid_5" class="form-input-wide" data-layout="full">
          ...
          <input type="text" id="fname" name="fname" class="form-textbox" data-defaultvalue="" autoComplete="section-input_5 family-name" size="15" data-component="last" aria-labelledby="label_5 sublabel_5_last" value="${vo.fname}"/>
          <label class="form-sub-label" for="fname" id="fname" style="min-height:13px">성</label>
          </span>
          
          <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
          <input type="text" id="lname" name="lname" class="form-textbox" data-defaultvalue="" autoComplete="section-input_5 given-name" size="10" data-component="first" aria-labelledby="label_5 sublabel_5_first" value="${vo.lname}"/>
      ...
      <label class="form-label form-label-top form-label-auto" id="label_6" for="input_6_addr_line1" aria-hidden="false"> 주소 </label>
        <div id="cid_6" class="form-input-wide" data-layout="full">
          ...
          <div class="form-address-table jsTest-addressField">
            ...
            <input type="text" id="addr1" name="addr1" class="form-textbox form-address-line" data-defaultvalue="" autoComplete="section-input_6 address-line1" data-component="address_line_1" aria-labelledby="label_6 sublabel_6_addr_line1"  value="${vo.addr1}"/>
            ...
            <span class="form-address-line form-address-street-line jsTest-address-lineField">
            <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" id="addr2" name="addr2" class="form-textbox form-address-line" data-defaultvalue="" autoComplete="section-input_6 address-line2" data-component="address_line_2" aria-labelledby="label_6 sublabel_6_addr_line2" value="${vo.addr2}"/>
            ...
            <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" id="zip" name="zip" class="form-textbox form-address-postal" data-defaultvalue="" autoComplete="section-input_6 postal-code" data-component="zip" aria-labelledby="label_6 sublabel_6_postal"  value="${vo.zip}"/>
      ...
      <label class="form-label form-label-top form-label-auto" id="tel" for="tel"> 전화번호 </label>
        <div id="cid_7" class="form-input-wide" data-layout="half">
         <span class="form-sub-label-container" style="vertical-align:top">
         <input type="text" id="tel" name="tel" data-type="mask-number" class="mask-phone-number form-textbox validate[Fill Mask]" data-defaultvalue="" autoComplete="section-input_7 tel-national" style="width:310px" data-masked="true" placeholder="(000) 000-0000" data-component="phone" aria-labelledby="label_7" value="${vo.tel}"/>
         </span> 
         </div>
      </li>
      <!------------------------ 이메일 ------------------->
      <li class="form-line form-line-column form-col-2" data-type="control_email" id="id_8"><label class="form-label form-label-top form-label-auto" id="email" for="email" aria-hidden="false"> 이메일 </label>
        <div id="cid_8" class="form-input-wide" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top">
        <input type="text" id="email" name="email" class="form-textbox validate[Email]" data-defaultvalue="" autoComplete="section-input_8 email" style="width:310px" size="310" placeholder="얘: myname@example.com" data-component="email" aria-labelledby="label_8 sublabel_input_8" value="${vo.email}"/>
        <label class="form-sub-label" for="email" id="email" style="min-height:13px"></label>
        </span> 
        </div>
      </li>
      <!------------------------ 카드번호 ------------------->
      <li class="form-line form-line-column form-col-2" data-type="control_email" id="id_8"><label class="form-label form-label-top form-label-auto" id="card" for="card" aria-hidden="false"> 카드번호 </label>
        <div id="cid_8" class="form-input-wide" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top">
        <input type="text" id="card" name="card" class="form-textbox validate[Email]" data-defaultvalue="" autoComplete="section-input_8 email" style="width:310px" size="310" placeholder="NNNN-NNNN-NNNN-NNNN" data-component="email" aria-labelledby="label_8 sublabel_input_8" value="${vo.card}"/>
        <label class="form-sub-label" for="card" id="card" style="min-height:13px"></label>
        </span> 
        </div>
      </li>
      <!------------------------ 카드 유효날짜 ------------------->
      <li class="form-line form-line-column form-col-2" data-type="control_email" id="id_8"><label class="form-label form-label-top form-label-auto" id="cdate" for="cdate" aria-hidden="false"> 카드 유효날짜 </label>
        <div id="cid_8" class="form-input-wide" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top">
        <input type="text" id="cdate" name="cdate" class="form-textbox validate[Email]" data-defaultvalue="" autoComplete="section-input_8 email" style="width:310px" size="310" placeholder="NN-" data-component="email" aria-labelledby="label_8 sublabel_input_8" value="${vo.cdate}"/>
      ...
      <label class="form-label form-label-top" id="label_10" for="lite_mode_10" aria-hidden="false"> 도착  날짜</label>
        <div id="cid_10" class="form-input-wide" data-layout="full">
          <div data-wrapper-react="true" class="extended">
            ...
            <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" class="form-textbox" id="dates" name="dates" size="12" data-maxlength="12" maxLength="12" data-age="" value="${vo.dates}" data-format="yyyy-MM-dd" data-seperator="-" placeholder="YYYY-MM-DD" data-placeholder="YYYY-MM-DD" autoComplete="off" aria-labelledby="label_10" />
      ...
      <!-- 출발 날짜 및 시간 -->
      <li class="form-line allowTime" data-type="control_datetime" id="id_11"><label class="form-label form-label-top" id="label_11" for="lite_mode_11" aria-hidden="false"> 출발  날짜  </label>
        <div id="cid_11" class="form-input-wide" data-layout="full">
          <div data-wrapper-react="true" class="extended">
            ...
            <!-- 일 -->
            <span class="form-sub-label-container" style="vertical-align:top">
            <input type="tel" class="form-textbox" id="day_11" name="q11_input11[day]" size="2" data-maxlength="2" data-age="" maxLength="2" value="" autoComplete="off" aria-labelledby="label_11 sublabel_11_day" />
            <label class="form-sub-label" for="day_11" id="sublabel_11_day" style="min-height:13px">Day</label>
            </span>
            </div>
            
            <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" class="form-textbox" id="datess" name="datess" size="12" data-maxlength="12" maxLength="12" data-age="" value="${vo.datess}" data-format="yyyy-MM-dd" data-seperator="-" placeholder="YYYY-MM-DD" data-placeholder="YYYY-MM-DD" autoComplete="off" aria-labelledby="label_11" />
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_phone" id="id_7">
      <label class="form-label form-label-top form-label-auto" id="adult" for="adult">성인 수</label>
        <div id="cid_7" class="form-input-wide" data-layout="half">
         <span class="form-sub-label-container" style="vertical-align:top">
         <input type="number" id="adult" name="adult" data-type="mask-number" class="mask-phone-number form-textbox validate[Fill Mask]" data-defaultvalue="" autoComplete="section-input_7 tel-national" style="width:310px" data-masked="true" data-component="date" aria-labelledby="label_7" value="${vo.adult}"/>
         </span> 
         </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_phone" id="id_7">
      <label class="form-label form-label-top form-label-auto" id="children" for="children">아동 수</label>
        <div id="cid_7" class="form-input-wide" data-layout="half">
         <span class="form-sub-label-container" style="vertical-align:top">
         <input type="number" id="children" name="children" data-type="mask-number" class="mask-phone-number form-textbox validate[Fill Mask]" data-defaultvalue="" autoComplete="section-input_7 tel-national" style="width:310px" data-masked="true" data-component="date" aria-labelledby="label_7" value="${vo.children}"/>
         </span> 
         </div>
      </li>
      ...
      <li class="form-line" data-type="control_text" id="id_4">
			<div id="cid_4" class="form-input-wide" data-layout="full">
				<input type="text" id="content" name="content" data-type="mask-number" class="mask-phone-number form-textbox validate[Fill Mask]" data-defaultvalue="" autoComplete="section-input_7 tel-national" style="width: 310px" data-masked="true" data-component="date" aria-labelledby="label_7"/> 
      ...
      <li class="form-line" data-type="control_button" id="id_2">
	        <div id="cid_2" class="form-input-wide" data-layout="full">
	          ...
	          <button type="submit" class="form-submit-button submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="" >수정하기</button>
	          </div>
	        </div>	
      </li>	
		</ul>
